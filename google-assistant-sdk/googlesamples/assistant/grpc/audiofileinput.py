...
def main(api_endpoint, credentials, device_model_id, device_id, lang, verbose,
    input_audio_file, output_audio_file, block_size, grpc_deadline, *args,
    **kwargs):
    ...
    def gen_assist_requests(input_stream):
        dialog_state_in = embedded_assistant_pb2.DialogStateIn(
            language_code=lang, conversation_state=b'')
    ...
    for resp in assistant.Assist(
        gen_assist_requests(input_audio_file), grpc_deadline):
